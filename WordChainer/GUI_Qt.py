...
class MenuWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.button1 = PicButton('easy', QPixmap("images/EASY.png"), QPixmap("images/kantan.png"), QPixmap("images/kantan.png"))
        self.button2 = PicButton('normal', QPixmap("images/NORMAL.png"), QPixmap("images/hutuu.png"), QPixmap("images/hutuu.png"))
        self.button3 = PicButton('hard', QPixmap("images/HARD.png"), QPixmap("images/muzui.png"), QPixmap("images/muzui.png"))
        self.button4 = PicButton('reverse', QPixmap("images/REVERSE.png"), QPixmap("images/atama.png"), QPixmap("images/atama.png"))
